...
<div id="reviews" class="woocommerce-Reviews">
  <div id="comments">
    <h4 class="alt-font woocommerce-Reviews-title">
      <?php
          ...
          <div id="review_form_wrapper">
            <div id="review_form">
              ...
              $comment_form = array(
                ...
                'title_reply_before' => '<h4 id="reply-title" class="alt-font text-dark-gray fw-500 mb-15px" role="heading" aria-level="3">',
              ...
              $comment_form['comment_field'] .= '<p class="comment-form-comment"><label for="comment">' . esc_html__('Your review', 'woocommerce') . '&nbsp;<span class="required">*</span></label><textarea id="comment" name="comment" cols="45" class="form-control" rows="8" required></textarea></p>';
